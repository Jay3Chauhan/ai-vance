...
class _DownloadModelScreenState extends ConsumerState<DownloadModelScreen>
  ...
  static const String _androidDownloadRoot = '/storage/emulated/0/AIVance';
  ...
  Future<void> _checkStoragePermission() async {
    ...
    if (mounted) setState(() => _hasStoragePermission = granted);
  }
  ...
  Future<void> _resolveDownloadsPath() async {
    ...
    if (Platform.isAndroid) {
      // Use shared device storage root for AIVance.
      path = _androidDownloadRoot;
    } else {
      final dir = await getDownloadsDirectory();
      final base = dir?.path ?? '';
      path = base.isEmpty ? '' : '$base/AIVance';
    }
    if (!mounted) return;
    setState(() {
      _downloadsPath = path;
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Browse models that fit your device RAM. Tap a model to download it into AIVance storage and auto-load it for chatting.',
                                    style: GoogleFonts.plusJakartaSans(
                                      fontSize: 14,
                                      color: colorScheme.onSurfaceVariant,
                                      height: 1.5,
                                  ...
                                  if (Platform.isAndroid && _hasStoragePermission == false) ...[
                                    ...
                                    Material(
                                      ...
                                      child: InkWell(
                                        onTap: () async {
                                          final granted = await openManageStorageSettings();
                                          if (mounted) setState(() => _hasStoragePermission = granted);
                                        },
                                        borderRadius: BorderRadius.circular(12),
                                        child: Padding(
                                              ...
                                              Expanded(
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    const SizedBox(height: 4),
                                                    Text(
                                                      'Android requires "All files access" to save models to AIVance. Tap here to enable "Allow access to manage all files".',
                                                      style: GoogleFonts.plusJakartaSans(
                                                        fontSize: 13,
                                                        color: colorScheme.onErrorContainer,
                                                        height: 1.4,
                                        ...
                                        Expanded(
                                          child: Text(
                                            _downloadsPath == null || _downloadsPath!.isEmpty
                                                ? 'Models will be saved into the AIVance folder in your storage.'
                                    ...
                                    if (!hasAccess) {
                                      await showDialog<void>(
                                        ...
                                        builder: (ctx) => AlertDialog(
                                          ...
                                          content: Text(
                                            'On Android 11+, saving models to the AIVance shared folder requires All files access.\n\n'
                                            'Please tap "Grant Access" and turn on "Allow access to manage all files".',
                                          ...
                                          actions: [
                                            ...
                                            FilledButton(
                                              onPressed: () async {
                                                ...
                                                final granted = await openManageStorageSettings();
                                                if (context.mounted) setState(() => _hasStoragePermission = granted);
                                              },
